    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center px-5 text-center"
        ...
        <div style={{ animation: 'cpShake .5s ease-out .03s both', display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%' }}>
          ...
          {/* ボタン */}
          <div className="flex flex-col gap-3 w-full max-w-sm md:max-w-[600px]" style={{ animation: 'cpSlideUp .4s ease-out .56s both', opacity: 0 }}>
    ...
    <div className="min-h-screen bg-slate-950 text-white">
      <div className="sticky top-0 z-20 bg-slate-950/95 backdrop-blur-sm border-b border-slate-800/60">
        <div className="max-w-[600px] mx-auto px-5 py-3 flex items-center gap-3">
          ...
          <h1 className="text-lg font-bold">🎯 単語を捕獲する</h1>
        </div>
      </div>
